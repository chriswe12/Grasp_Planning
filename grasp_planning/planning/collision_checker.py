"""Geometry-based collision checks for the FR3 scene."""
...
class CollisionChecker:
    ...
    def _ensure_scene_query_state(self) -> None:
        ...
        if not colliders:
            raise RuntimeError(
                f"No collision-enabled GPrims found under robot root '{self._robot_root_path}'. "
                "The planner requires collision geometry on the FR3 asset."
            )
