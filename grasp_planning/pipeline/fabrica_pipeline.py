...
class IsaacPipelineConfig:
    ...
    headless: bool = False
    d405_wrist_camera_enabled: bool = False
    d405_width: int = 848
    d405_height: int = 480
    d405_fx: float = 470.900
    d405_fy: float = 432.971
    d405_cx: float = 423.5
    d405_cy: float = 239.5
    d405_privileged_mask_enabled: bool = True
    record_video: str = ""
    visual_servo_goal_image: str = ""
    visual_servo_comparison_video: str = ""
    curriculum_dataset_dir: str = ""
    curriculum_episodes: int = 0
    curriculum_seed: int = 0
    curriculum_episode_offset: int = 0
    curriculum_num_envs: int = 1
    curriculum_writer_workers: int = 1
    curriculum_sample_hz: float = 10.0
    curriculum_ee_position_noise_grasp_m: tuple[float, float, float] = (0.0, 0.0, 0.0)
    curriculum_ee_rotation_noise_deg: tuple[float, float, float] = (0.0, 0.0, 0.0)
    curriculum_video: str = ""
