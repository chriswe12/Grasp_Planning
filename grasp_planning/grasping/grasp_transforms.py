...
def saved_grasp_to_world_grasp(
    ...
    *,
    ...
    execution_rotmat_world = _mesh_grasp_rotmat_to_execution_rotmat(mesh_grasp_rotmat_world)
    orientation_xyzw_world = rotmat_to_quat_xyzw(execution_rotmat_world)
    approach_axis_world = execution_rotmat_world[:, 0]
